...
dash.register_page(__name__, name='Player Profile', title='Player Profile | EffectiveFootball',
                   image="Player_Profile.png",
                   description='EffectiveFootball player profile charts',
                   path='/')
